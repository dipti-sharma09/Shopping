...
if ( ! function_exists( 'tmpcoder_header_markup' ) ) {
	...
	function tmpcoder_header_markup() {
		...
		<header id="site-header" class="tmpcoder-site-header" role="banner">
            <div class="site-header">
                ...
                <nav class="site-navigation">
                    <div class="wp-mobile-toggle-wrap">
                        ...
                        if( class_exists( 'Redux_Framework_Plugin', false )) {
                            ...
                            { 
                                $content = sprintf(
                                    ...
                                    'Copyright [COPYRIGHT] [CURRENT_YEAR] [SITE_TITLE] | Powered by <a href="%1$s" target="_blank" rel="noopener nofollow">%2$s</a>', esc_url('https://sastraessentialaddons.com/'), esc_html('SastraWP WordPress Theme') );
            ...
            <?php if ( apply_filters( 'tmpcoder_page_title', true ) ) : ?>
                <header class="page-header">
                    <h1 class="entry-title">
                        <?php echo esc_html__( 'Search results for: ','sastrawp' ); ?>
