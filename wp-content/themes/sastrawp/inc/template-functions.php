...
if (!function_exists('tmpcoder_add_custom_site_icon')) {
	...
	function tmpcoder_add_custom_site_icon($url){
		...
		if ( Tmpcoder_Site_Settings::tmpcoder_has('tmpcoder_fav_site_icon') ) {
			if (isset(Tmpcoder_Site_Settings::tmpcoder_get('tmpcoder_fav_site_icon')['url']) && Tmpcoder_Site_Settings::tmpcoder_get('tmpcoder_fav_site_icon')['url'] != "") {
				return Tmpcoder_Site_Settings::tmpcoder_get('tmpcoder_fav_site_icon')['url'];
			}
		}
	} 
}
